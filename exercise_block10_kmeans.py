...
# load data #
# -- pre-coded -- #
pth = r"C:\gd\knowledge\f05_ml\___PLAYGROUND\dsml2021\block10\exercise\ccc.csv"
df = pd.read_csv(pth)
df.describe()
df.dtypes
df.isna().sum()
...
# -- pre coded -- #
sns.pairplot(df)
df = df[["Total_visits_online", "Avg_Credit_Limit"]] # we choose these two features, it seems there are two clusters here
